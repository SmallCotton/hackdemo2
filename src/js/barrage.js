...
var CanvasBarrage = function (canvas, video, options) {
	...
	var Barrage = function (obj) {
		...
		this.init = function () {
			...
			span.style.font = 'bold ' + fontSize + 'px "YouYuan", "Helvetica Neue", "Microsoft YaHei", sans-serif';
		...
		this.draw = function () {			
			...
			context.font = this.fontSize + 'px "YouYuan", "Helvetica Neue", "Microsoft YaHei", sans-serif';
			if (/rgb\(/.test(this.color)) {
				context.fillStyle = 'rgba('+ this.color.split('(')[1].split(')')[0] +','+ this.opacity +')';
				//context.strokeStyle = 'rgba('+ this.color.split('(')[1].split(')')[0] +','+ this.opacity +')';
				context.stroke = 'rgba('+ this.color.split('(')[1].split(')')[0] +','+ this.opacity +')';
